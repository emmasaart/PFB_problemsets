...
def main():
    ...
    for seq in seq_list:
        all_kmers += sequence_to_kmer_list(seq,kmer_length)
    ...
    sorted_kmer_dict = dict(sorted(kmer_count_dict.items(), key =lambda kmers_tuple: kmers_tuple[1], reverse = True))

    unique_kmers = list(sorted_kmer_dict.keys())[0:num_top_kmers_show]
    ## end your code
